...
[📄 查看源码](https://gitcode.com/cann/ops-nn/tree/master/activation/hard_swish_grad)
...
每个算子分为[两段式接口](../../../docs/zh/context/两段式接口.md)，必须先调用“aclnnHardswishBackwardGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnHardswishBackward”接口执行计算。
...
## aclnnHardswishBackwardGetWorkspaceSize
