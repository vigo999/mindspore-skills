...
[📄 查看源码](https://gitcode.com/cann/ops-nn/tree/master/activation/swish_grad)
...
int main()
{
    ...
    ret = aclrtMemcpy(
        outData.data(), outData.size() * sizeof(outData[0]), gradInputDeviceAddr, size * sizeof(outData[0]),
