...
- **返回值：**
  ...
  <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
    ...
    <tbody>
      ...
      <td>161001</td>
      <td>传入的self或valuesOut是空指针时。</td>
      </tr>
      <tr>
      <td rowspan="3">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="3">161002</td>
      <td>self和valuesOut的数据类型不在支持的范围之内。</td>
      </tr>
      <tr>
      <td> self和valuesOut的数据类型不同。</td>
      </tr>
      <tr>
      <td>valuesOut的shape与实际输出shape不匹配。</td>
      </tr>
    </tbody> 
    </table>
...
- **参数说明**
  ...
  <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
      ...
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnMedianGetWorkspaceSize获取。</td>
      </tr>
      <tr>
      <td>executor</td>
      <td>输入</td>
