...
* **返回值**：
  ...
  <tbody>
    ...
    <tr>
      <td>self和other数据类型不满足数据类型推导规则时。</td>
    </tr>
    <tr>
      <td>self和out的shape不同时。</td>
    </tr>
    <tr>
      <td>self和out的维度大于8时。</td>
    </tr>
  </tbody>
  </table>
...
* **返回值**：
  ...
  <tbody>
    ...
    <tr>
      <td>selfRef和other的数据类型不满足数据类型推导规则时。</td>
    </tr>
    <tr>
      <td>selfRef的维度大于8时。</td>
    </tr>
  </tbody>
  </table>
...
**aclnnNeScalar&aclnnInplaceNeScalar接口调用示例代码：**
