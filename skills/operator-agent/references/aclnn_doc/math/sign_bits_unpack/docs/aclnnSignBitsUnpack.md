...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>self、out的数据类型\数据格式不在支持的范围内。</td>
    </tr>
    <tr>
      <td>size小于等于0或者 （self的元素个数）* 8 % size != 0。</td>
    </tr>
    <tr>
      <td>out的数据类型与dtype不一致。</td>
    </tr>
    <tr>
      <td>self的维度不是1维。</td>
    </tr>
    <tr>
      <td>out的第一维度与size不一致。</td>
    </tr>
  </tbody>
  </table>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnSignBitsUnpackGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
