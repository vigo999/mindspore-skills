...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>self和other的数据类型和维度不在支持的范围之内。</td>
    </tr>
    <tr>
      <td>self和other不满足数据类型推导规则。</td>
    </tr>
    <tr>
      <td>推导出的数据类型和维度无法转换为指定输出out的类型和维度</td>
    </tr>
    <tr>
  ...
  <table style="undefined;table-layout: fixed; width: 1149px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        <td>workspaceSize</td>
        <td>输入</td>
        <td>在Device侧申请的workspace大小，由第一段接口aclnnFmodScalarGetWorkspaceSize获取。</td>
      </tr>
      <tr>
        <td>executor</td>
        <td>输入</td>
  ...
  <table style="undefined;table-layout: fixed; width: 1149px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        <td>workspaceSize</td>
        <td>输入</td>
        <td>在Device侧申请的workspace大小，由第一段接口aclnnInplaceFmodScalarGetWorkspaceSize获取。</td>
      </tr>
      <tr>
        <td>executor</td>
        <td>输入</td>
