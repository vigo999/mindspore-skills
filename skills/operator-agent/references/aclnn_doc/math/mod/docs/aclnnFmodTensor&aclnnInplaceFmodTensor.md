...
[📄 查看源码](https://gitcode.com/cann/ops-math/tree/master/math/mod)
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>self和other的数据类型和数据格式和维度不在支持的范围之内。</td>
    </tr>
    <tr>
  ...
  <table style="undefined;table-layout: fixed; width: 1149px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        <td>workspaceSize</td>
        <td>输入</td>
        <td>在Device侧申请的workspace大小，由第一段接口aclnnFmodTensorGetWorkspaceSize获取。</td>
      </tr>
      <tr>
        <td>executor</td>
        <td>输入</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td rowspan="5">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="5">161002</td>
      <td>selfRef和other的数据类型和数据格式和维度不在支持的范围之内。</td>
    </tr>
    <tr>
      <td>selfRef和other的dtype不满足数据类型推导规则。</td>
    </tr>
    <tr>
      <td>推导出的数据类型无法转换为指定输出out的类型。</td>
    </tr>
