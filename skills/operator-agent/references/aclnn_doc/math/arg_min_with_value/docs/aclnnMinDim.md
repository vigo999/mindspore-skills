...
[📄 查看源码](https://gitcode.com/cann/ops-math/tree/master/math/arg_min_with_value)
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        数据类型和self一致。<br>
        如果keepdim为false，则输出维度为self维度减1；<br>
        如果keepdim为true，则输出维度等于self维度。
      </td>
      <td>FLOAT、FLOAT16、INT64、BOOL、BFLOAT16、INT32</td>
      <td>ND</td>
      <td>根据keepdim决定</td>
  ...
  - <term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term>：
    - self和out的数据类型不支持BFLOAT16、INT32。

  - <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>：
    - self和out的数据类型不支持INT32。
...
- **返回值：**
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>传入的self、out和indices是空指针时。</td>
    </tr>
    <tr>
      <td rowspan="2">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="2">161002</td>
      <td>self、out、indices数据类型不在支持的范围内时。</td>
    </tr>
    <tr>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnMinDimGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
