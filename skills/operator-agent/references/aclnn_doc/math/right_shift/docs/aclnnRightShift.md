...
- **返回值：**
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>input、shiftBits、out存在空指针。</td>
    </tr>
    <tr>
      <td rowspan="5">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="5">161002</td>
      <td>input、shiftBits、out的数据类型不在支持的范围之内。</td>
    </tr>
    <tr>
      <td>input、shiftBits的数据类型不支持类型推导。</td>
    </tr>
    <tr>
      <td>input、shiftBits的数据维度大于8。</td>
    </tr>
    <tr>
      <td>input、shiftBits的shape不满足broadcast规则。</td>
    </tr>
    <tr>
      <td>input、shiftBits的shape在broadcast之后与out的shape不一致。</td>
    </tr>
  </tbody>
  </table>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnRightShiftGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
