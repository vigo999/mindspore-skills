...
- **返回值**
  ...
  <tbody>
    ...
    <tr>
      <td>self或out为空tensor，且self最后两个维度的值存在0。</td>
    </tr>
    <tr>
      <td>padding的数值大于等于self最后一维度的值。</td>
    </tr>
    <tr>
      <td>out最后一维的值不等于self最后一维的值加padding的两个值。</td>
    </tr>
  </tbody>
  </table>
...
- **参数说明** 
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnReplicationPad1dGetWorkspaceSize获取</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
