...
[📄 查看源码](https://gitcode.com/cann/ops-math/tree/master/conversion/fill)
...
```cpp
aclnnStatus aclnnInplaceFillTensor(
    void          *workspace, 
    uint64_t       workspaceSize, 
    aclOpExecutor *executor, 
    aclrtStream    stream)
...
- **返回值**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>参数selfRef的数据类型不在支持范围内。</td>
    </tr>
    <tr>
      <td>参数value的数据维度大于1维。</td>
    </tr>
    <tr>
      <td>参数value的数据维度=1，但size!=1。</td>
    </tr>
    <tr>
...
- **参数说明**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnInplaceFillTensorGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
