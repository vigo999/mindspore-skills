...
USAGE = """Usage:
  Folder conversion:
    python hf_transformers_auto_convert.py --src_root /path/to/src --dst_root /path/to/dst
  Single-file in-place conversion:
    python hf_transformers_auto_convert.py --src_file /path/to/file.py --inplace
"""
