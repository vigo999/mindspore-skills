...
MINT_METHODOLOGY = SKILL_ROOT / "reference" / "index" / "mint_api_methodology.md"
QUERY_SCRIPT = SKILL_ROOT / "scripts" / "query_mint_api_index.py"
BUILDER_SCRIPT = SKILL_ROOT / "scripts" / "index_builders" / "generate_mindspore_failure_index.py"
LOCAL_MINDSPORE_REPO = Path("D:/Atomgit/mindspore4agent")
